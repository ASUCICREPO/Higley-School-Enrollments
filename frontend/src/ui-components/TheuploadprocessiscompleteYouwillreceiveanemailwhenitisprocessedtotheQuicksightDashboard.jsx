...
export default function TheuploadprocessiscompleteYouwillreceiveanemailwhenitisprocessedtotheQuicksightDashboard(
  props
) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(
        overrides,
        "TheuploadprocessiscompleteYouwillreceiveanemailwhenitisprocessedtotheQuicksightDashboard"
      )}
      {...rest}
    >
      <Text
